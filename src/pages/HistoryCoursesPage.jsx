    ...
    return (
        <div className="course-page">
            ...
            <main className="params-grid">
                <Link className="param-card theme-history" to="/CourseDetailPage">
                    <span>ПАРАМЕТР</span>
                </Link>
                <button className="param-card theme-history"></button>
                <button className="param-card theme-history"></button>
                <button className="param-card theme-history"></button>
                <button className="param-card theme-history"></button>
                <button className="param-card theme-history"></button>
...
export default HisoryCoursesPage;