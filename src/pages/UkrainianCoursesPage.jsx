    ...
    return (
        <div className="course-page">
            ...
            <main className="params-grid">
                <Link className="param-card theme-ukr" to="/CourseDetailPage">
                    <span>ПАРАМЕТР</span>
                </Link>
                <button className="param-card"></button>
                <button className="param-card"></button>
                <button className="param-card"></button>
                <button className="param-card"></button>
                <button className="param-card"></button>
...
export default UkrainianCoursesPage;